...
use crate::rpc_service::{P2pUserData, current_time_secs, UTXO};
use crate::utils::{
...
use store::{
    ...
    GraphTickActionMetaData, Instance, MessageState, MessageType, WatchContract,
    WatchContractStatus,
};
...
pub async fn scan_l1_broadcast_txs(
    ...
    if !discarded_instances.is_empty() {
        ...
        .await?;
        tx.update_graphs_state_by_instance_ids(
